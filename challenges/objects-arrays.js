...
function dino(name, diet, weight, length, period){
  const dinosaur = {}
    ...
    dinosaur.length = length;
    dinosaur.period = period;
  return dinosaur
}

// tyrannosaurus, carnivorous, 7000kg, 12m, Late Cretaceous
const tyrannosaurus = dino('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceous');
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = dino('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor = dino('velociraptor', 'carnivorous', '15kg', '1.8m', 'Late Cretaceous');
